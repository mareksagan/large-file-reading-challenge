package com.recruitment.temperatures.assertions;
...
public final class Assert {
    ...
    public static final class IntegerAsserter {
         ...
         * @throws NumberValueTooLowException     if the value is below min
         */
        ...
        /**
         * Ensure that the input value is below the given value
         *
    ...
    public static final class FloatAsserter {
         ...
         * @return The current asserter
         * @throws MissingMandatoryValueException if value is null
         * @throws NumberValueTooHighException    if the value is below floor
         */
        ...
        /**
         * Ensure that the input value is below the given ceil
         *
         ...
         */
        public FloatAsserter below(float ceil) {
            notNull(field, value);
    ...
    public static final class DoubleAsserter {
         ...
         * @throws NumberValueTooHighException    if the value is over ceil
         */
        public DoubleAsserter below(double ceil) {
            notNull(field, value);
    ...
    public static final class BigDecimalAsserter {
         ...
         * @return The current asserter
         * @throws MissingMandatoryValueException if the input value is null
         * @throws NumberValueTooLowException     if the input value is below the min value
         */
         ...
         * @return The current asserter
         * @throws MissingMandatoryValueException if value is null
         * @throws NumberValueTooLowException     if the value is below floor
         */
         ...
         * @throws NumberValueTooHighException    if the value is below floor
         */
        public BigDecimalAsserter below(long ceil) {
            return below(new BigDecimal(ceil));
        }
         ...
         * @throws NumberValueTooHighException    if the value is below floor
         */
        public BigDecimalAsserter below(BigDecimal ceil) {
            notNull();
